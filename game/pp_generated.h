...
/* Forward declared functions. */
 int stbsp__real_to_parts(__int64  * bits, int  * expo, double   value);
static char* stbsp__clamp_callback(char  * buf, void  * user, int   len);
 int stbsp__real_to_parts(__int64  * bits, int  * expo, double   value);
static void stbsp__raise_to_power10(double  * ohi, double  * olo, double   d, int   power);
 ...
 void sgl_memcpy(void  * dest, void  * src, uintptr_t   num);
